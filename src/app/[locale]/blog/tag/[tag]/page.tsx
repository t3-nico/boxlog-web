...
export async function generateMetadata({ params }: TagPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'jp' ? `/jp/blog/tag/${tag}` : `/blog/tag/${tag}`,
    }
  }
}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <nav className="mb-8" aria-label="パンくず">
              <ol className="flex items-center justify-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                <li>
                  <a href={locale === 'jp' ? '/jp/' : '/'} className="hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
                    {locale === 'jp' ? 'ホーム' : 'Home'}
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href={locale === 'jp' ? '/jp/blog' : '/blog'} className="hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
                    {locale === 'jp' ? 'ブログ' : 'Blog'}
                  </a>
                </li>
                <li>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                {locale === 'jp' ? '他のタグを探す' : 'Explore other tags'}
              </a>
            </div>
          </div>
        </Container>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {allTags
                        ...
                        .map((tagItem) => (
                          <a
                            key={tagItem.tag}
                            href={locale === 'jp' ? `/jp/blog/tag/${encodeURIComponent(tagItem.tag)}` : `/blog/tag/${encodeURIComponent(tagItem.tag)}`}
