          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-100 rounded-2xl opacity-20" />
                <div className="relative z-10 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
                  ...
                  <Heading as="h2" size="2xl" className="mb-4 text-blue-900">
                    {companyMission.title}
                  </Heading>
                  
                  <Text size="lg" className="font-semibold text-blue-800 mb-4">
              ...
              {/* Vision */}
              <div className="relative">
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-purple-100 rounded-2xl opacity-20" />
                <div className="relative z-10 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100">
                  ...
                  <Heading as="h2" size="2xl" className="mb-4 text-purple-900">
                    {companyVision.title}
                  </Heading>
                  
                  <Text size="lg" className="font-semibold text-purple-800 mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {companyValues.map((value, index) => (
                <div
                  key={value.id}
                  className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-blue-200 group"
                >
