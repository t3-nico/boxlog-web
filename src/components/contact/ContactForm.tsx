              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <Text className="font-medium">メール</Text>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <Text className="font-medium">電話</Text>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <Text className="font-medium">所在地</Text>
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div>
                  ...
                  />
                  {errors.name && (
                    <Text id="name-error" size="sm" className="text-red-600 mt-1">
                      {errors.name}
                    </Text>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.email && (
                    <Text id="email-error" size="sm" className="text-red-600 mt-1">
                      {errors.email}
                    </Text>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.subject && (
                    <Text id="subject-error" size="sm" className="text-red-600 mt-1">
                      {errors.subject}
                    </Text>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.message && (
                    <Text id="message-error" size="sm" className="text-red-600 mt-1">
                      {errors.message}
                    </Text>
                  )}
