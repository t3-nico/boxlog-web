    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            {hasActiveFilters && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                {selectedTags.length + selectedTypes.length + (searchQuery ? 1 : 0) + (showBreakingOnly ? 1 : 0) + (showFeaturedOnly ? 1 : 0)} active
              </span>
            )}
          </div>
      ...
      <div className={`lg:block ${isExpanded ? 'block' : 'hidden'}`}>
        <div className="p-6 space-y-6">
          {/* Search */}
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-3">検索</h4>
          ...
          {/* Quick Filters */}
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-3">クイックフィルター</h4>
            <div className="space-y-3">
              <label className="flex items-center cursor-pointer group">
                ...
                />
                <span className="ml-3 flex items-center gap-2 text-sm text-gray-600 group-hover:text-gray-900">
