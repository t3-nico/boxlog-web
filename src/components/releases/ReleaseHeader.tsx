      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-wrap items-center gap-6 text-gray-600">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900">リリース日</div>
          ...
          {frontMatter.author && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">リリース責任者</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900">バージョン種別</div>
        ...
        <div className="flex flex-wrap gap-3 mt-8">
          ...
          {frontMatter.breaking && (
            <span className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium bg-red-100 text-red-800 border border-red-200">
        ...
        {frontMatter.tags.length > 0 && (
          <div className="mt-8">
            <h3 className="text-sm font-medium text-gray-700 mb-3">関連タグ</h3>
            <div className="flex flex-wrap gap-2">
              {frontMatter.tags.map((tag) => (
                <a
                  key={tag}
                  href={`/releases/tag/${encodeURIComponent(tag)}`}
                  className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-white text-gray-700 border border-gray-200 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 transition-colors"
                >
                  #{tag}
                </a>
              ))}
