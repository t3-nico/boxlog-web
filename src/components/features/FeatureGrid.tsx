        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div
              ...
              className={`group relative p-8 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-gray-100 hover:-translate-y-1 cursor-pointer dark:bg-gray-800 dark:border-gray-700 dark:hover:shadow-gray-900/50 ${
                hoveredFeature === feature.id
                  ? 'border-blue-300 shadow-lg dark:border-blue-600'
                  : ''
              }`}
            ...
            >
              ...
              {/* Category Badge */}
              <div
                className={`inline-flex items-center px-3 py-1 text-xs font-medium rounded-full border mb-4 ${categoryColors[feature.category]}`}
              >
              ...
              <Heading
                as="h3"
                size="xl"
                className="mb-3 group-hover:text-blue-600 transition-colors dark:group-hover:text-blue-400"
              >
                {feature.title}
              </Heading>
