    ...
    <div className="grid min-h-screen grid-cols-1 grid-rows-[1fr_auto_1fr] bg-white lg:grid-cols-[max(50%,36rem)_1fr] dark:bg-neutral-900">
      ...
      <header className="mx-auto w-full max-w-7xl px-6 pt-6 sm:pt-10 lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:px-8">
        <Link href="/" className="inline-block">
          ...
          <div className="text-2xl font-bold text-neutral-900 dark:text-white">BoxLog</div>
        </Link>
      </header>
      ...
      <main className="mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
        <div className="max-w-lg">
          {code && <p className="text-base font-semibold text-neutral-900 dark:text-neutral-400">{code}</p>}
          <h1 className="mt-4 text-5xl font-semibold tracking-tight text-neutral-900 sm:text-6xl dark:text-white">
            {title}
          </h1>
          <p className="mt-6 text-lg font-medium text-neutral-500 sm:text-xl dark:text-neutral-400">{description}</p>
