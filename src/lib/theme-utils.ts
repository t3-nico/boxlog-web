...
export type ThemeColorType =
  ...
  | 'release-new-text'
  | 'release-new-border'
  | 'release-improvement-bg'
  | 'release-improvement-text'
  | 'release-improvement-border'
  | 'release-bugfix-bg'
  | 'release-bugfix-text'
  | 'release-bugfix-border'
  | 'release-breaking-bg'
  | 'release-breaking-text'
  | 'release-breaking-border'
  | 'release-security-bg'
  | 'release-security-text'
  | 'release-security-border'
  // その他
  | 'highlight-bg'
  | 'highlight-text'
  | 'icon-bg-primary'
 ...
 */
export function getReleaseColors(
  type: 'new' | 'improvement' | 'bugfix' | 'breaking' | 'security'
) {
  const colorMap = {
    new: {
 ...
 */
export function getReleaseTypeClasses(
  type: 'new' | 'improvement' | 'bugfix' | 'breaking' | 'security'
): string {
